...
class TestShape(unittest.TestCase):
    ...
    def test_init(self):
        gm.Box([1, 1, 1], sm.SE3(0, 0, 0))
        gm.Cylinder(1, 1, sm.SE3(2, 0, 0))
        gm.Sphere(1, sm.SE3(4, 0, 0))

    def test_color(self):
        shape = gm.Box([1, 1, 1], sm.SE3(0, 0, 0))
    ...
    def test_closest(self):
        s0 = gm.Box([1, 1, 1], sm.SE3(0, 0, 0))
        s1 = gm.Cylinder(1, 1, sm.SE3(2, 0, 0))
        s2 = gm.Sphere(1, sm.SE3(4, 0, 0))
    ...
    def test_collision(self):
        s0 = gm.Box([1, 1, 1], sm.SE3(0, 0, 0))
        s1 = gm.Box([1, 1, 1], sm.SE3(0.5, 0, 0))
        s2 = gm.Box([1, 1, 1], sm.SE3(3, 0, 0))
